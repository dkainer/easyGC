...
peak_parser.add_argument('-TS','--trimstart', required=True, default="0.0", help='time in minutes (X.XX) in the chromatogram from where the analysis should begin. Helps to cut out junk at the start', type=str)
peak_parser.add_argument('-TE','--trimend', required=True, default="20.0", help='time in minutes (X.XX) in the chromatogram where the analysis should end. Helps to cut out junk at the end', type=str)
