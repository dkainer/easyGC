...
peak_parser.add_argument('-i', '--indir', required=True, help='[REQUIRED] directory containing your GC-MS files to be processed', type=str)
...
align_parser.add_argument('-e', '--exprdir', required=True, help='[REQUIRED] the path to the .expr files from a previous peak calling run. These will be aligned.', type=str)
...
pipe_parser.add_argument('-i', '--indir', required=True, help='[REQUIRED] directory containing your GC-MS files to be processed', type=str)
